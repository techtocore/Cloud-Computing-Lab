 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://akash/", wsdlLocation = "http://localhost:8080/WebApplication2/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://akash/", "NewWebService");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://akash/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://akash/", "NewWebServicePort"), NewWebService.class, features);
    }
